...
class RegisterModal extends React.Component{
    ...
    render(){
        ...
        return(
            ...
            <div style={{height:"100vh", width:"100vw",backgroundColor:"#232222"}}>
                ...
                <div className="Modal fade-in">
                    ...
                    <Link to={{pathname:"/payment", state:{registration_fee:this.props.location.state.registration_fee, data :{
                    event_id:this.props.match.params.id,
                    registration_fee:this.props.location.state.registration_fee,
                    first_name: this.state.first_name,
                    last_name:this.state.last_name,
                    ...
                    phone_number:this.state.phone_number,
                    address:this.state.address
                    }}}}><Button className="btn-success btn-block"> Submit</Button></Link>

                    <Link to={{pathname:"/event"}}><Button className="btn-danger btn-block" >Cancel</Button></Link>
